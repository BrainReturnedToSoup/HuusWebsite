export default function Details() {
  return (
    <div className="pt-14 flex flex-col items-center justify-center">
      <h1 className="lato-bold text-xl mb-4">About me</h1>
      <p className="leading-relaxed">
        ...
        convallis ornare. Nostra fusce rutrum per ridiculus velit dapibus
        vulputate malesuada luctus. Vivamus arcu aliquam laoreet sem ipsum.
        Donec mus purus praesent sem vehicula tellus eu risus. Cursus et
        pulvinar id iaculis metus ornare dapibus egestas fringilla. Elementum
        ...
        laoreet aptent odio aenean. Nam luctus habitasse nunc tortor; non
        conubia aliquam. Class blandit mauris; montes consectetur eros tempor
        sed. Amet phasellus at morbi mattis; parturient nulla pharetra. Dolor
        duis malesuada adipiscing cubilia lacus? Dis tristique vivamus blandit
        neque id. Maximus pellentesque vehicula vitae sagittis tristique
        nascetur donec faucibus ad. Fusce magnis maecenas ante convallis dolor
        semper. Ullamcorper suscipit a vehicula penatibus fermentum penatibus mi
        ullamcorper. Cubilia diam purus blandit; vivamus blandit maximus
        molestie. Vestibulum maximus neque elit et dolor est donec scelerisque.
        Class dolor molestie placerat fusce massa. Cubilia orci natoque mus
        platea malesuada vulputate. Turpis molestie blandit aliquam ridiculus
